...
After installation, AeroSpace checks for application updates with Sparkle. You can also choose
`Check for Updates…` from the AeroSpace menu. Homebrew remains the installation and
